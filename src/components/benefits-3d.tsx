...
export function Benefits3DSection() {
  ...
  return (
    <section id="benefits" className="relative z-10 bg-transparent py-20 md:py-28 px-4 sm:px-6 md:px-8 overflow-hidden" style={{ perspective: "1200px" }}>
      ...
      <div className="absolute top-1/3 left-1/4 -z-10 h-72 w-72 rounded-full bg-[#99F54E]/10 blur-[120px] pointer-events-none animate-orbFloat" />
      <div className="absolute bottom-1/4 right-1/4 -z-10 h-80 w-80 rounded-full bg-indigo-500/10 blur-[120px] pointer-events-none animate-orbFloat" style={{ animationDelay: "5s" }} />

      <div ref={sectionRef} className="mx-auto max-w-7xl">
        <div className="text-center max-w-2xl mx-auto mb-14 md:mb-20 scroll-reveal">
          <p className="text-[#99F54E] text-xs sm:text-sm font-semibold uppercase tracking-wider mb-2">Why WebbHeads</p>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/5 shrink-0 group-hover:border-purple-400/50 group-hover:bg-purple-500/10 group-hover:scale-105 transition-all duration-300 shadow-md">
                    <Icon className="h-6 w-6 text-purple-400" strokeWidth={1.8} />
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-purple-400 transition-colors leading-snug">
                    {item.title}
                  </h3>
                </div>
